...
## Figures
![](/research/images/clf_rl_theory_hero_fig.png "The main ideas behind CLF guided RL. A CLF is designed offline and used in an RL/optimal control problem as the reward/cost. Then the optimal policy is applied to the system resulting in provable exponential stability and in stable humanoid locomotion.")
...
**Paper**: [arxiv](https://arxiv.org/abs/2605.01978)
